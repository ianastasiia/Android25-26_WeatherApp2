...
fun AppNavHost(navController: NavHostController) {
    NavHost(
        ...
        composable(route = Screen.SavedCities.route) {
            SavedCitiesScreen(
        ...
        composable(
            ...
            val city = backStackEntry.arguments?.getString(Screen.CurrentWeather.ARG_CITY)!!
        ...
        composable(
            ...
            val city = backStackEntry.arguments?.getString(Screen.Forecast.ARG_CITY)!!
